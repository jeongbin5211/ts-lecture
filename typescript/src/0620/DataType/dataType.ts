...
// u2 = 1; => '1' 형식은 'undefined' 형식에 할당할 수 없습니다.
...
// 모든 타입의 값을 가질 수 있습니다. (모든 타입의 루트 타입이자 최상위 타입)
let a: any = 0;
a = "hello";
a = true;
a = {};
...
let sym1 = Symbol();
let sym2 = Symbol("key"); // string Key값으로 인지(옵션으로 사용할 수 있게 됨)

//? bigint
// 0n, 2n, -3n, ... 길이의 제약 없이 정수를 다룰 수 있게 해주는 숫자형
// 숫자가 너무 클때 number 대신 사용
const theBiggestInt = BigInt(8922222023442389332);